...
!************************************
    ...
    if (iexample .eq.3 .or. iexample .eq. 6 .or. iexample .eq. 7 .or. iexample .eq. 2) then
    do i=0, nd
...
!***************************************************************************
    ...
    error2(l)=sqrt(error2(l)/nx)
        ...
        if(l.eq.nl)then
        write(7000, *) cfl/udif*umax,error1(l)
        endif
